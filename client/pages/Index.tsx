        ...
        >
          ...
          <div className="space-y-4 relative">
            ...
            <motion.h1 
              ...
              className="relative z-10 text-7xl md:text-9xl font-black uppercase leading-[0.85] tracking-tighter"
            >
              The Next <br />
            ...
            <motion.p 
              ...
              className="relative z-10 text-slate-400 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed uppercase tracking-tight"
            >
